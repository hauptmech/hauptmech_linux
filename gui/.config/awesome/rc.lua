...
-- }}}
--{{
init_theme = function (theme_name)
...
-- beautiful.init("sr/share/awesome/themes/default/theme.lua")
...
for s = 1, screen.count() do
    ...
    -- We ned one layoutbox per screen.
...
os.execute('truecrypt --mount /mnt/sd/traveler.tc&')
-- }}}
